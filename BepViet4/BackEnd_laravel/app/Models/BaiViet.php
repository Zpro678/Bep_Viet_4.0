...
class BaiViet extends Model
{
    ...
    public static function danhSach(array $filters)
    {
        return self::query()
            ...
            ->with([
                'nguoiDung:ma_nguoi_dung,ho_ten,anh_dai_dien', // Đảm bảo bảng nguoi_dung có cột anh_dai_dien
                'hinhAnh' 
            ])
            // --- QUAN TRỌNG: Thêm dòng này để đếm số bình luận ---
            // Nó sẽ tạo ra field "binh_luan_count" trong kết quả trả về
            ->withCount('binhLuan') 
